...
const BIO_AR_500 = `عايدة كرييتف ستوديوز (AIDA Creative Studios) معهد فلسطيني نقدي من القدس، أسّسه حمزة برهمية سنة ٢٠٢٢. اشتغالنا قائم على فكرة بسيطة: التصميم منهج بحث، مش تزيين. اللي بنرسمه لمطعم بشعفاط هو نفسه السؤال اللي بنحلّله في تقرير عن إقصاء اللاجئين الفلسطينيين من النظام الرقمي. الشغل ما بنفصله.
