export const goldenLineMobile = {
  ...
  results: [
    ...
    { label: "Brand Colors", value: "5" },
    { label: "Social Templates", value: "12+" },
    { label: "Content System", value: "Full DNA" },
  ],
  process: [
    {
      step: "Discovery",
    ...
    {
      step: "Brand DNA",
      description: "Defined the Deep Charcoal + Burnished Gold palette. Selected Amiri and Cairo typography for Arabic-first design.",
    },
    {
      step: "Logo System",
      description: "Created 5 logo variants — each suited for different contexts: social media, print, embossed packaging, digital watermarks.",
    },
    {
      step: "Content System",
      description: "Built reusable social templates with Jerusalemite dialect copy, WhatsApp CTAs, and seasonal campaign frameworks.",
    },
  ],
  palette: [
    { name: "Deep Charcoal", hex: "#121212" },
    { name: "Matte Obsidian", hex: "#1A1A1B" },
    { name: "Burnished Gold", hex: "#C5A059" },
    { name: "Slate Gray", hex: "#2A2A2D" },
    { name: "Warm White", hex: "#F5F0E8" },
  ],
  logoVariants: ["Obsidian", "Leather", "Glass", "Shield", "Vector"],
};
