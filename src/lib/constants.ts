export const SITE = {
  ...
  description:
    "Brand identity, social media management, and digital strategy for Palestinian businesses in Jerusalem. Trilingual creative agency serving Jerusalem and beyond.",
