...
const clients = [
  {
    ...
    descEn: "Premium phone accessories & smartphones — wholesale and retail with delivery across Jerusalem.",
    descAr: "إكسسوارات وموبايلات فخمة — جملة ومفرق مع توصيل عبر القدس.",
    location: "Jerusalem",
    locationAr: "القدس",
  ...
  },
  {
    ...
    nameAr: "الضيعة شعفاط",
    descEn: "Authentic Arabic cuisine — shawarma, grills, and family meals with delivery across Jerusalem and nearby neighborhoods.",
    descAr: "أكل عربي أصيل — شاورما، مشاوي، ووجبات عائلية مع توصيل بالقدس والأحياء المجاورة.",
    location: "Jerusalem",
    locationAr: "القدس",
    whatsapp: "",
    facebook: "",
